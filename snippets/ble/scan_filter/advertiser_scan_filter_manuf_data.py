...
manuf_data = bytes([0x77, 0x00, 0xFE, 0xED, 0xBE, 0xE5])  # Example manufacturer specific data
advert.add_ltv(canvas_ble.AD_TYPE_MANU_SPECIFIC, manuf_data, False)
...
# Start advertising
advert.start()
print('Advertising started with manufacturer specific data:', manuf_data.hex())
