#
# LED strip snippet designed for use with the Sera NX040 DVK
#
# Rename this file to `main.py` and load onto the Sera NX040 DVK.
# When rebooted, the LED on the DVK will cycle through various colors.
# Type Ctrl-C on the REPL UART to interrupt the script.
#
import time
