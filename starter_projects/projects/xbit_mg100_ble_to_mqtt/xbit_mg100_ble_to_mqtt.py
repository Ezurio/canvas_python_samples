...
# Description: Cellular/Ethernet BLE to MQTT bridge
#
# For use with MG100, Pinnacle 100 DVK and BL5340 DVK
# or other Zephyr-based Canvas boards with network connectivity.
#
...
class SntpClient:
    def __init__(self, config):
        ...
        if self.hostname is None:
            ...
            self.sntp = sntp_client.Sntp()
        else:
            # Use specified SNTP server
            self.sntp = sntp_client.Sntp(host=self.hostname)
